      ...
      <Card className="w-full max-w-md shadow-soft border-0 animate-fade-in">
        <CardContent className="p-8">
          <div className="flex flex-col items-center mb-6">
            <div className="w-14 h-14 rounded-full bg-primary/30 flex items-center justify-center mb-3">
              <Baby className="w-7 h-7 text-primary-foreground" />
            </div>
            <h1 className="text-3xl font-display">Baby Journal</h1>
          ...
          <Button variant="outline" className="w-full rounded-full h-11" onClick={handleGoogle} disabled={loading}>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <button onClick={() => setMode(mode === "signin" ? "signup" : "signin")} className="text-primary-foreground font-semibold hover:underline">
